...
const Footer = () => (
  <footer className="d-flex flex-wrap justify-content-between align-items-center py-3 border-top" style={{ fontFamily:'Nunito, sans-serif', boxShadow: '0 4px 8px rgba(0, 0, 0, 0.1)', backgroundColor:'#EAF6F6', padding:'10px', marginTop:'20px'}}>
