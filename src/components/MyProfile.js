...
const MyProfile = () => {
  ...
  return (
    <div className="container my-profile px-4 py-2" id='myProfileMainDiv'>
      ...
      {profileData ? (
        <div>
          <p class='myProfilePersonalInfoParagraph'>Name: {profileData.name}</p>
          <p class='myProfilePersonalInfoParagraph'>Email: {profileData.email}</p>
          ...
          {showUpdateForm && (
            <div className="mb-3">
              ...
              <input
                ...
                className="form-control"
              />
              <button id='myProfileMargin' onClick={handleSubmit} className="btn btn-success">
                Submit
              </button>
            </div>
          )}
          {error && (
            <div id='myProfileErrorDiv' className="alert alert-info" role="alert">
              <p>{error}</p>
        ...
        <p id='myProfileLoading'>Loading profile...</p>
      )}
      </div>
     <div className="col-md-9">
      {bookedEventsSummary ? (
        <div>
          ...
          <ul>
            {bookedEventsSummary.map((event) => (
             <div className="card text-center" id='myProfileBookedEventsMainDiv'>
             <div className="card-header" id='myProfileBookedEventsHeaderDiv'>
               <h3>Event Name: {event.eventName}</h3>
             </div>
             <div className="card-body" id='myProfileBookedEventsBodyDiv'>
             ...
             <div className="card-footer text-body-secondary" id='myProfileBookedEventsFooterDiv'>
               <p>EMS</p>
             </div>
           </div>
            ))}
        ...
        <p id='myProfileLoading'>Loading booked events...</p>
      )}
    </div>
  </div>
</div>
